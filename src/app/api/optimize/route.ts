...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const chatCompletion = await openai.chat.completions.create({
      messages: [{
        role: 'user', content: `
        Here are several examples of plain texts and their improved versions as processed by an AI model. Please analyze these examples and generate a similar improved version for a new input text using the same guidelines and style adjustments. 
